...
web3.personal.unlockAccount(web3.eth.accounts[0], "111111111");
var simple = simpleContract.new(42, {from:web3.eth.accounts[0], data: simpleCompiled[simpleRoot].code, gas: 300000, privateFor: ["qyLQOeh9s8Y8nAEKHM1Y/LiIB5E3utqptFlJtmKKF0o="]}, function(e, contract) {
  if (e) {
